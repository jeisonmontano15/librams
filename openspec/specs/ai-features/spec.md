...
## Purpose
Defines the AI-assisted capabilities layered over the catalogue: natural language search, librarian-facing description generation, and personalised borrowing recommendations, along with the resilience and provider-independence rules those features must satisfy.
## Requirements
