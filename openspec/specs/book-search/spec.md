...
## Purpose
Defines how the catalogue is discovered: full-text search across title, author, and description, filtering by genre and availability, how those filters combine, pagination of results, and enumeration of available genres.
## Requirements
