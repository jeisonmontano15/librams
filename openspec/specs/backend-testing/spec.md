...
## Purpose
Defines the automated test coverage required of the backend, spanning repository behaviour and endpoint integration, so that catalogue and loan logic stays verifiable.
## Requirements
