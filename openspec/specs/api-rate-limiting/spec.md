...
## Purpose
Defines the request-rate protections applied to the AI endpoints, which call a metered external provider, and confirms that ordinary catalogue and loan traffic remains unthrottled.
## Requirements
